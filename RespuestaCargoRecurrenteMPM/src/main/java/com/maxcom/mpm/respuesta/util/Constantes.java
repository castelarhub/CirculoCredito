package com.maxcom.mpm.respuesta.util;
...
public class Constantes {
    ...
    /*Constantes para la orden*/
    public static final String COMPONENTE_ORDEN="COMPONENTE_X";
    ...
    public static final String SISTEMA_DETALLE="SISTEMA_X";
    public static final String MODIFICADO_POR_DETALLE="NCM";
